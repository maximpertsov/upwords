...
Whoever draws the tile nearest to the letter"AH plays first. Play then
passes to the left. Return the tiles, letter-side down, to the draw pile
and mix them up again. I I
...
draw pile to replace the ones you played. b

IMPORTANT: A word is legal and can be used in the game if it is in the

dictionary and it does not fall into any of the categories of illegal words

listed in Rule 7 on page 5. 
...
- You score 2 extra bonus points if you use theUQu" letter tile in any word
  ...
  points if you use the"Quntile in a word formed with any of its letters
...
- If you form two or more words on the same turn, each word is scored.
  ...
  each word. For example, in Figure 3 (page 3), the letternN" is common to
  the words ON and NET.The word ON scores 4 pointkand the word NET
...
- Words that are always capitalized &e illegal.
...
When one player uses all of hidher letter tiles, and no tiles remain in
the draw pile; or
...
(from which to exchange a letter tile); or
...
a time, and score points for every word y~u make. NOTE: During the game,
...
We will be happy to hear your questions or comments about this game.US consumers

write to: Hasbro Games, Consumer Affairs Dept., P.O. Box 200, Pawtucket, RI 02862.

Tel: 888-836-7025 (toll free). Canadian consumers please write to: Hasbro Canada

Corporation, 2350 de la Province, Longueuil, QC Canada, J4G 1 G2.
...
Canada. All Rights Reserved." & @ denote U.S.Trademarks.
